---
title: "Couser Project: Reproducible Pitch Presentation-Iris Dataset"
...
- On the left side, two select boxes show the variables that describe the Iris data set. Two select boxes are used for the user to choose which variables will be displayed on the X-axis and the Y-axis.
